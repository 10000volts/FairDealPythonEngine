from utils.constants import ECardRank, ECardType, ELocation, ETimePoint, EGamePhase
...
class GamePlayer:
    ...
    游戏中的玩家。
    """
    def __init__(self, p, deck, side, leader_card_id):
...
class Match:
    ...
    一次比赛（三局两胜）。
    """
    def __init__(self, p1, p1deck, p1side, p1leader_id,
                 p2, p2deck, p2side, p2leader_id, match_config):
        """
...
class Game:
    ...
    def __init__(self, players, game_config, last_loser):
        self.tp_stack = list()
